"""dx.scatter_geo chart render test."""
...
my_scatter_geo = dx.scatter_geo(t, lat="Lat", lon="Lon", size="Pop", title="Geo Scatter")

scatter_geo_widget = ui.panel(my_scatter_geo, title="Geo Scatter")
