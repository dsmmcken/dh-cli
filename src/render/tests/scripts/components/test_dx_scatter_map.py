"""dx.scatter_map chart render test."""
...
my_scatter_map = dx.scatter_map(t, lat="Lat", lon="Lon", size="Pop", title="Map Scatter")

scatter_map_widget = ui.panel(my_scatter_map, title="Map Scatter")
